...
- Update all the packages(sudo apt update -y) and then clone the code.
- Clone your application's code repository onto the EC2 instance:
  ```bash
  git clone https://github.com/MdHazratAli36/DevSecOps-CI-CD-pipeline-to-deploy-a-Netflix-clone-on-the-cloud-using-Jenkins-Kubernetes-and-relat.git
  ```
...
1. **Install Jenkins for Automation:**
   ...
   - for confirmation of jenkins

   ```
    sudo service jenkins status
   ```

   if status is running then follow bellow
